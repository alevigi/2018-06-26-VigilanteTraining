...
address: "Seminar room 2 - Center for Stem Cells and Regenerative Medicine, 28th Floor Tower wing Guy's hospotal"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
humandate: "October 2-3, 2018"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Alessandra Vigilante, Rocio Martinez Nunez"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
{% comment %}helper: ["FIXME"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]{% comment %}
email: ["alessandra.vigilante@kcl.ac.uk"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
